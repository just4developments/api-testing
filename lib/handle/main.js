...
global.CustomType = class CustomType {
...
global.Length = function Length(from, to) {
  class LengthType extends CustomType {
    constructor(from, to) {
      super('Length');
      if (to === undefined) {
        this.value = from;
...
module.exports = class Main {
  ...
  constructor(pathProject) {
    ...
    if (this.config.declareVar)
      global.var = utils.assign(global.var, this.config.declareVar);
