module.exports = {
  ...
  defaultInit: { // Declare default value for testcase, or api. But you can override all of them in each testcase or api
    api: { 
      ...
      transformRequest: "json", // [form, json]: Describe request data which is key-value (form) or json data (json)
  ...
  testcases: ['declare/user','user'] // Declare testcases which is used to test APIs in them 
}