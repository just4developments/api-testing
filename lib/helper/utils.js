...
exports = module.exports = {
  ...
  anyCompare: (a, b, isNotEquals) => {
    ...
    if ('function' === typeof b) {
      ...
      for (var i in a) {
        if (!isNotEquals && !exports.anyCompare(a[i], b[i], isNotEquals)) {
          exports.mes.push(`<${i}> field`);
          return false;
        } else if (isNotEquals && exports.anyCompare(a[i], b[i], isNotEquals)) {
          exports.mes.push(`<${i}> field`);
          return true;
        }
      }
  ...
  typeCompare: (a, b, isNotEquals) => {
    ...
    if (!isNullOrEmpty && (a === undefined || a === null)) {
      ...
      if (typeof a === type.toLowerCase()) {
        ...
        return true;
      } else if (b === Length && (a instanceof Array || typeof a === 'string')) {
        var isOk = true;
